# Atomic Detection Pipeline - MITRE ATT&CK Emulation and SIEM Detection
...
| Log Forwarder | ossec-agent (Wazuh 4.x) | Ships Sysmon and Windows logs to the Wazuh manager |
...
Twinkle Devwanshi is a Supply Chain Analyst with over 4 years of experience analyzing demand, inventory, and logistics data to improve operational performance. This project represents an application of structured data analysis and technical monitoring to the field of cybersecurity. By integrating SQL-based logic and SIEM telemetry, Twinkle focuses on enhancing visibility and coordination across complex systems. This repository is currently maintained by Twinkle Devwanshi, building upon the original work of Shyam Srujan Mukkamala.